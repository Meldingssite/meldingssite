...
function constructMelding(meldingData) {
    var melding = "";
    melding += '<div class="alertItem"><div><img src"public/images/category-FirstAid.png" alt="alert type"><p class="type">Ongeval</p><p class="time">' + meldingData['TimeStamp']
        + '</p></div><div style="background: url("public/images/category-FirstAid.png")"><h1>' + meldingData['locatie'] + '</h1><p>' + toggleSpace(meldingData['locatieSpecifiek'])
